(() => {
    ...
    (() => {
        ...
        da.init();
        let script_button = document.getElementById("toggleButtonPrice");
        if (script_button) {
            function pricePage() {
                let block1 = document.getElementById("block1111");
                let block2 = document.getElementById("block2222");
                ...
                script_button.classList.toggle("_active-button");
            }
            document.getElementById("toggleButtonPrice").addEventListener("click", (function(priceStart) {
                pricePage();
            }));
        }
        window["FLS"] = true;
